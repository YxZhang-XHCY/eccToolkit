...
class TestParallelImports:
    ...
    def test_import_parallel(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.parallel import (
            ParallelConfig,
            get_optimal_workers,
            serialize_pool,
...
class TestParallelConfig:
    ...
    def test_default_config(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.parallel import ParallelConfig
...
class TestGetOptimalWorkers:
    ...
    def test_auto_workers(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.parallel import get_optimal_workers
...
class TestPoolSerialization:
    ...
    def test_serialize_empty_pool(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.parallel import serialize_pool
        from ecctoolkit.simulate._wip_full.rca_readsim.debranch import LinearMoleculePool
...
class TestProgressTracker:
    ...
    def test_progress_tracker(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.parallel import ProgressTracker
...
class TestCLIParallelOptions:
    ...
    def test_sim_reads_help_shows_threads(self):
        """Test readsim --help shows threads option."""
        import subprocess
