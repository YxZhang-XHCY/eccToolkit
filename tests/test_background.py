...
class TestBackgroundImports:
    ...
    def test_import_config_with_background(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.config import SimConfig, BackgroundDNAParams
        config = SimConfig()
...
class TestBackgroundDNACalculation:
    ...
    def test_calculate_count(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.background import calculate_background_count
...
class TestBackgroundDNAGenerator:
    ...
    def test_generator_init(self, test_reference):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.background import BackgroundDNAGenerator
...
class TestModelsWithBackground:
    ...
    def test_sequenced_read_background_fields(self):
        ...
        from ecctoolkit.simulate._wip_full.rca_readsim.models import SequencedRead
...
class TestCLIBackgroundOptions:
    ...
    def test_sim_reads_help_shows_background_options(self):
        """Test readsim --help shows basic options."""
        import subprocess
        ...
        # full mode uses -i for input, lite mode uses -r for reference
        assert "-i" in result.stdout or "-r" in result.stdout
