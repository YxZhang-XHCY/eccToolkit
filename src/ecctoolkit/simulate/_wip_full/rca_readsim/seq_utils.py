...
_COMPLEMENT_TABLE[ord('n')] = ord('n')
# IUPAC 模糊碱基
_COMPLEMENT_TABLE[ord('R')] = ord('Y')
_COMPLEMENT_TABLE[ord('Y')] = ord('R')
_COMPLEMENT_TABLE[ord('S')] = ord('S')
_COMPLEMENT_TABLE[ord('W')] = ord('W')
_COMPLEMENT_TABLE[ord('K')] = ord('M')
_COMPLEMENT_TABLE[ord('M')] = ord('K')
_COMPLEMENT_TABLE[ord('B')] = ord('V')
_COMPLEMENT_TABLE[ord('V')] = ord('B')
_COMPLEMENT_TABLE[ord('D')] = ord('H')
_COMPLEMENT_TABLE[ord('H')] = ord('D')
