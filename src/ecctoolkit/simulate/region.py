...
- MeccDNA (Multi-mapped): Multiple genomic locations match at >=99% identity with >=99% length consistency
...
def run_region_simulation(
    ...
    max_length_multi: int = 10000,
    # Alignment parameters
    identity: float = 99.0,
    min_coverage: float = 90.0,
    length_consistency: float = 99.0,
    multi_coverage: float = 95.0,
    max_secondary: int = 50,
    no_hit_policy: str = "skip",
    split_by_length: bool = False,
    split_length: int = 10000,
    ...
    keep_tmp: bool = False,
    verbose: bool = False,
    # ML training data options
    generate_ml_data: bool = False,
    ml_identity_threshold: float = 99.0,
) -> None:
    """
    Simulate eccDNA regions from reference genome.
    ...
    Args:
        ...
        max_length_multi: Maximum length for MeccDNA (multi-mapped)
        identity: Minimum identity threshold for classification (%)
        min_coverage: Minimum coverage threshold (%)
        length_consistency: Length consistency threshold (%)
        multi_coverage: Coverage threshold (%) for counting non-self hits as Multi-mapped
        ...
        generate_ml_data: Generate ML training data (doubled sequences + alignment TSV)
        ml_identity_threshold: Identity threshold for ML training data (%)
    ...
    try:
        ...
        config = SimulationConfig(
            ...
            length_consistency_threshold=length_consistency,
            multi_coverage_threshold=multi_coverage,
            ...
            ml_identity_threshold=ml_identity_threshold,
        )
