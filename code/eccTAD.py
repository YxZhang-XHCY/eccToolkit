...
class eccTADAnalysis:
    def __init__(self, args):
        ...
        self.keep_sex_chr = args.keep_sex_chr  # New parameter for sex chromosome filtering
    ...
    def plot_tad_sensitivity(self, results_df):
        ...
        for boundary_type in ['Strong', 'Weak', 'All']:
            ...
            plt.errorbar(buffer_sizes, fold_enrichments,
    ...
    def generate_report(self, results_df):
        ...
        total_eccdna = len(pd.read_csv(self.temp_dir / 'eccdna_all.bed', sep='\t', header=None))
...
"""
    ...
    def run_analysis(self):
        ...
        try:
            ...
            # Run analysis
            results_df = self.analyze_tad_enrichment(eccdna_file, tad_df, self.n_shuffles)
...
Examples:
  ...
  %(prog)s -i eccDNA.csv -t TAD.bed -w ./output --cores 32 --prefix experiment_001
    ...
    parser.add_argument('--keep-sex-chr', action='store_true',
